    ...
    const cheat = (async () => {
        ...
        const Cheats = {
            ...
            gold: [
                {
                    name: "Always x99999...",
                    description: "Always x99999...",
                    type: "toggle",
                    enabled: false,
                    data: { type: "multiply", val: 99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999, text: "x99999... Gold!", blook: "Captain Blackbeard" },
                    run: function () {
                        let stateNode = getStateNode();
            ...
            hack: [
                ...
                },
                {
                    ...
                    run: function () {
                        if (!this.enabled) {
                            this.enabled = true;
                            this.data = setInterval((state) => getStateNode().setState(state), 25, { choices: [{ type: "mult", val: 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999, rate: 0.075, blook: "Mega Bot", text: "x99999... Hack" }] });
                        } else {
                            this.enabled = false;
                            clearInterval(this.data);
                            this.data = null;
